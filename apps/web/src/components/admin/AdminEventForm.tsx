...
const copy = {
  ...
  hi: {
    ...
    description: 'नए प्रकाशित कार्यक्रम तुरंत सार्वजनिक कार्यक्रम पृष्ठ पर दिखाई देंगे।',
    titleLabel: 'शीर्षक',
    ...
    optional: 'वैकल्पिक',
    choose: 'फ़ाइल चुनें',
    noCover: 'कोई छवि चयनित नहीं है',
    noVideo: 'कोई वीडियो चयनित नहीं है',
    submit: 'कार्यक्रम बनाएं',
    submitting: 'बनाया जा रहा है...',
    success: 'कार्यक्रम सफलतापूर्वक बनाया गया।',
    error: 'कार्यक्रम बनाया नहीं जा सका।',
  },
  mr: {
    title: 'कार्यक्रम तयार करा',
    description: 'नवे प्रकाशित कार्यक्रम लगेच सार्वजनिक कार्यक्रम पानावर दिसतील.',
    titleLabel: 'शीर्षक',
    ...
    optional: 'ऐच्छिक',
    choose: 'फाइल निवडा',
    noCover: 'कोणतीही प्रतिमा निवडलेली नाही',
    noVideo: 'कोणताही व्हिडिओ निवडलेला नाही',
    submit: 'कार्यक्रम तयार करा',
    submitting: 'तयार करत आहे...',
    success: 'कार्यक्रम यशस्वीपणे तयार झाला.',
    error: 'कार्यक्रम तयार करता आला नाही.',
  },
} as const;
