...
const copy = {
  ...
  mr: {
    ...
    phone: 'फोन नंबर',
    email: 'ईमेल पत्ता',
    password: 'खात्याचा पासवर्ड',
    passwordHelp: 'किमान 8 अक्षरे ठेवा. त्यात मोठे अक्षर, छोटे अक्षर, संख्या आणि चिन्ह असावे.',
    confirmPassword: 'पासवर्डची पुष्टी करा',
    aadhar: 'आधार क्रमांक',
    aadharHelp: 'AES-256-GCM एन्क्रिप्शनद्वारे सुरक्षित साठवला जातो.',
    photo: 'प्रोफाइल फोटो',
    photoPlaceholder: 'JPG, PNG, किंवा WebP अपलोड करा (कमाल 2MB)',
    choose: 'निवडा',
    genericError: 'अर्ज जमा करता आला नाही',
    success:
      'आपला अर्ज जमा झाला आहे. मंजुरी प्रलंबित असताना आपण आपल्या नवीन खात्याने लॉगिन करू शकता.',
    proceedLogin: 'लॉगिनकडे जा',
    submit: 'सदस्यत्व अर्ज जमा करा',
    submitting: 'अर्ज जमा होत आहे...',
  },
} as const;
