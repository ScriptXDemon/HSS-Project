...
const copy = {
  en: {
    ...
    itemLabel: 'Activity item {index}',
    closePreview: 'Close activity preview',
    previousItem: 'Previous item',
    nextItem: 'Next item',
    itemCounter: 'Item {current} of {total}',
  },
  hi: {
    imageAlt: 'गतिविधि छवि',
    playVideo: 'वीडियो चलाएँ',
    itemLabel: 'गतिविधि आइटम {index}',
  ...
  mr: {
    imageAlt: 'उपक्रम प्रतिमा',
    playVideo: 'व्हिडिओ चालवा',
    itemLabel: 'उपक्रम आयटम {index}',
